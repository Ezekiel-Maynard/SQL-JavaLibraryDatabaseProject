...
public class AuthorAdd extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Add an Author");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
          ...
          st.executeUpdate("INSERT INTO author_info (author_id, author_last_name, author_first_name, country) VALUES('"+authorid+"','"+lastname+"','"+firstname+"','"+country+"')");
