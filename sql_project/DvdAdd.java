...
public class DvdAdd extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Admin View");

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel6.setText("Add DVD");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
          ...
          st.executeUpdate("INSERT INFO author_info (author_id, author_last_name, author_first_name, country) VALUES('"+dvdid+"','"+title+"','"+genre+"','"+price+"')");
