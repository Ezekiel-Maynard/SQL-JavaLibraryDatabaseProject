...
public class BookList extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (jTable1.getColumnModel().getColumnCount() > 0) {
            ...
            jTable1.getColumnModel().getColumn(1).setHeaderValue("Author ID");
            jTable1.getColumnModel().getColumn(2).setHeaderValue("Book Title");
            jTable1.getColumnModel().getColumn(3).setHeaderValue("Genre");
            jTable1.getColumnModel().getColumn(4).setHeaderValue("Section");
